...
myApp.service('cpService', function () {
...
proto._ok_clicked = function (e) {
	...
	this.hide();
	this._focus_to_target();
	triggerEvent(this.nodes.target, 'change'); //angularはchangeイベントを拾うのでここで発火させておく
};
...
//_add_event_listener(window, "click", _cPickerInit);

var cpicks = [];

this._cPickerInit =function(){
